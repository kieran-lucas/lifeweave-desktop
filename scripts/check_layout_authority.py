...
MAX_RESIDUE = {
    ...
    "font_size": 63,  # feature-local sizes remaining before semantic-role migration
    "focus": 18,       # local focus-visible recipes remaining before shared utility migration
