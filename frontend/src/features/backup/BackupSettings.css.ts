...
globalStyle(`${table} th`, { textAlign: "left", padding: "8px", borderBottom: "1px solid var(--paint-edge-strong)", background: "#F7F8FA", ...text.label, color: "var(--text-muted)" });
...
globalStyle(`${table} tbody tr:hover`, { background: "#FAFBFC" });
