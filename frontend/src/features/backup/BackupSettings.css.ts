...
globalStyle(`${table} th`, { textAlign: "left", padding: "7px 8px", borderBottom: "1px solid var(--border-strong)", ...text.label, color: "var(--text-muted)" });
globalStyle(`${table} td`, { padding: "9px 8px", verticalAlign: "top", borderBottom: "1px solid var(--border-subtle)", ...text.compactBody, fontVariantNumeric: "tabular-nums" });
...
export const dialog = dialogSurface.compact;
