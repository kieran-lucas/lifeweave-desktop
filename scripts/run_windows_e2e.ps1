...
try {
  ...
  foreach ($phase in @('phase1-lifecycle.e2e.ts','phase2-backup-restore.e2e.ts','phase3-restart.e2e.ts','phase4-portable-roundtrip.e2e.ts','phase4-portable-restart.e2e.ts')) {
