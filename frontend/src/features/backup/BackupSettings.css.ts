...
export const primaryButton = style({ padding: "8px 16px", border: 0, borderRadius: "var(--radius-control)", background: "var(--accent)", color: "var(--accent-contrast)", fontWeight: 700, cursor: "pointer", selectors: { "&:disabled": { opacity: 0.55, cursor: "not-allowed" } } });
