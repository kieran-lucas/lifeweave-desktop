...
Product semantics of any kind. No schema 28, migration, Rust product change, IPC command, Tauri
capability, network service, backup-format change, or workflow/seal change. No framework, editor,
