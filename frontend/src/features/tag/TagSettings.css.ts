...
export const input = style({ flex: 1, minInlineSize: 0, boxSizing: "border-box", padding: "7px 10px", border: "1px solid var(--border-subtle, var(--border-subtle))", borderRadius: 4, fontSize: 14 });
