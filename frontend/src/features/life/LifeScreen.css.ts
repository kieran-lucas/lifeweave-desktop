...
export const pinButton=style({position:"absolute",top:8,right:8,zIndex:2,width:32,height:32,padding:0,minBlockSize:0,border:"1px solid var(--border-subtle)",borderRadius:9,background:"var(--app-background)",color:"var(--text-primary)",cursor:"pointer"});
