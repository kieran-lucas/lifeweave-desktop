...
export const rowChip = style([button.ghost, compact, { maxInlineSize: "20rem", minBlockSize: 0, textAlign: "left", justifyContent: "flex-start", alignItems: "flex-start", overflowWrap: "anywhere", whiteSpace: "normal", color: "var(--accent)", borderColor: "var(--paint-edge)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)" }]);
export const priorityDot = style({ display: "inline-block", inlineSize: 6, blockSize: 6, borderRadius: "var(--radius-full)", background: "var(--accent)", boxShadow: "none", flexShrink: 0 });
...
export const wheel = style({ display: "flex", alignItems: "center", gap: space.x1, minInlineSize: 0, border: "1px solid var(--paint-edge)", borderRadius: "var(--radius-control)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)", boxShadow: "none", overflow: "hidden" });
...
export const subGroup = style({ display: "flex", flexDirection: "column", gap: space.control, margin: 0, padding: space.x3, border: "1px solid var(--paint-edge)", borderRadius: "var(--radius-control)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)", minInlineSize: 0 });
...
export const undo = style({ ...text.metadata, display: "flex", flexWrap: "wrap", alignItems: "center", alignSelf: "flex-start", gap: space.x1, margin: 0, padding: `${space.x1} ${space.x2}`, border: "1px solid var(--paint-edge)", borderRadius: "var(--radius-control)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)", color: "var(--text-muted)", boxShadow: "none" });
export const undoButton = button.ghost;
export const seriesTagsNote = style({ fontSize: 11, color: "var(--text-muted)", margin: "4px 0 0" });
export const dialogError = style({ ...text.compactBody, margin: 0, padding: `${space.x2} ${space.x3}`, border: "1px solid var(--danger)", borderRadius: "var(--radius-control)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)", color: "var(--danger)" });
...
export const timerStrip = style({ display: "flex", flexWrap: "wrap", gap: space.control, alignItems: "center", padding: `${space.x2} ${space.x3}`, border: "1px solid var(--accent)", borderRadius: "var(--radius-control)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)", boxShadow: "none" });
export const timerRunning = style({ ...text.eyebrow, color: "#FFFFFF", border: "1px solid var(--accent)", borderRadius: "var(--radius-small)", padding: "2px 6px", backgroundColor: "var(--accent)" });
...
export const timerError = style({ ...text.compactBody, margin: 0, padding: `${space.x2} ${space.x3}`, border: "1px solid var(--danger)", borderRadius: "var(--radius-control)", backgroundColor: "#FFFFFF", backgroundImage: "var(--paint-grain-fine)", color: "var(--danger)" });
