...
export const note = style({ margin: 0, padding: "8px 10px", borderInlineStart: "3px solid var(--accent)", borderRadius: "0 var(--radius-control) var(--radius-control) 0", backgroundColor: "var(--paint-selected)", backgroundImage: "var(--paint-grain-fine)", ...text.metadata });
export const backdrop = style([dialogBackdrop, { backdropFilter: "none", WebkitBackdropFilter: "none" }]);
export const dialog = style([dialogSurface.compact, { backgroundColor: "var(--paint-sheet-strong)", backgroundImage: "var(--paint-grain-fine), var(--paint-wash-blue)", borderColor: "var(--paint-edge-strong)", "@media": { "(forced-colors: active)": { border: "1px solid currentColor", background: "Canvas", color: "CanvasText" } } }]);
...
export const warnings = style({ margin: 0, padding: "10px 12px 10px 28px", borderInlineStart: "3px solid var(--accent)", borderRadius: "0 var(--radius-control) var(--radius-control) 0", backgroundColor: "var(--paint-selected)", backgroundImage: "var(--paint-grain-fine)", ...text.compactBody });
