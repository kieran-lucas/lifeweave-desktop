...
globalStyle(`${table} th`, { textAlign: "left", fontWeight: 600, fontSize: 12, color: "var(--text-muted, var(--text-muted))", padding: "4px 8px", borderBottom: "1px solid var(--border-subtle, var(--border-subtle))" });
globalStyle(`${table} td`, { padding: "6px 8px", borderBottom: "1px solid var(--border-subtle, var(--border-subtle))", fontSize: 14 });
...
export const mergePanel = style({ display: "flex", flexDirection: "column", gap: 8, padding: 12, background: "var(--surface-raised)", borderRadius: "var(--radius-small)", border: "1px solid var(--border-subtle, var(--border-subtle))" });
export const mergeRow = style({ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" });
export const select = style({ padding: "6px 8px", border: "1px solid var(--border-subtle, var(--border-subtle))", borderRadius: "var(--radius-small)", fontSize: 14, background: "var(--surface, #fff)" });
export const warning = style({ color: "var(--danger)", fontSize: 13, margin: 0 });
export const mergeConfirm = style({ background: "var(--surface, #fff)", border: "1px solid var(--border-subtle, var(--border-subtle))", borderRadius: "var(--radius-small)", padding: 12, display: "flex", flexDirection: "column", gap: 8 });
