...
*Superseded by `docs/audits/task-21-final-remediation.md` (second remediation) and `docs/audits/task-21-closure.md` (final closure). This document records the P1 defects from the first remediation only.*
