...
export const focal=style({width:"min(520px,100%)",padding:24,border:"1px solid var(--glass-border)",borderRadius:"var(--radius-floating)",background:"var(--glass-surface-strong)",boxShadow:"0 16px 44px color-mix(in srgb, var(--text-primary) 8%, transparent)",color:"var(--text-primary)",textAlign:"left"});
