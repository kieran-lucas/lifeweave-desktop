...
export const heading = style({ margin: 0, color: "var(--text-primary)", ...text.display, textShadow: "0 14px 38px color-mix(in srgb, var(--accent-violet) 14%, transparent)" });
...
export const scene = style({
  ...
  background: "radial-gradient(540px 260px at 7% 8%, color-mix(in srgb, var(--accent-cyan) 10%, transparent), transparent 68%), radial-gradient(620px 300px at 88% 96%, color-mix(in srgb, var(--accent-violet) 9%, transparent), transparent 72%)",
});
...
export const focal = style({
  ...
  background: "linear-gradient(135deg, color-mix(in srgb, var(--accent-cyan) 11%, var(--glass-surface-strong)), color-mix(in srgb, var(--accent-violet) 10%, var(--glass-surface-strong)))",
  color: "var(--text-primary)",
  textAlign: "left",
  boxShadow: "var(--glow-hero)",
  "@supports": { "(backdrop-filter: blur(1px)) or (-webkit-backdrop-filter: blur(1px))": { backdropFilter: "blur(18px) saturate(1.2)", WebkitBackdropFilter: "blur(18px) saturate(1.2)" } },
});
...
export const card = style({
  ...
  background: "linear-gradient(145deg, color-mix(in srgb, white 34%, transparent), transparent 48%), var(--glass-surface)",
  color: "var(--text-primary)",
  textAlign: "left",
  cursor: "pointer",
  ...
  selectors: {
    "&:hover": {
      background: "linear-gradient(145deg, color-mix(in srgb, var(--accent-cyan) 12%, var(--glass-surface-strong)), color-mix(in srgb, var(--accent-violet) 9%, var(--glass-surface-strong)))",
      borderColor: "color-mix(in srgb, var(--accent) 38%, var(--border-subtle))",
      boxShadow: "var(--glow-hover)",
      transform: "translateY(-2px)",
    },
  },
  "@supports": { "(backdrop-filter: blur(1px)) or (-webkit-backdrop-filter: blur(1px))": { backdropFilter: "blur(14px) saturate(1.16)", WebkitBackdropFilter: "blur(14px) saturate(1.16)" } },
...
export const pinButton = style({ position: "absolute", top: 10, right: 10, zIndex: 2, minBlockSize: 30, padding: "5px 8px", border: "1px solid transparent", borderRadius: "var(--radius-control)", background: "transparent", color: "var(--text-muted)", fontSize: 12, fontWeight: 650, cursor: "pointer", selectors: { "&:hover": { background: "color-mix(in srgb, var(--accent) 9%, var(--glass-surface-strong))", borderColor: "color-mix(in srgb, var(--accent) 18%, transparent)", color: "var(--accent)" } } });
export const icon = style({ display: "inline-grid", placeItems: "center", width: 34, height: 34, borderRadius: "var(--radius-control)", background: "linear-gradient(135deg, color-mix(in srgb, var(--accent-cyan) 24%, white), color-mix(in srgb, var(--accent-violet) 18%, white))", color: "var(--accent)", border: "1px solid color-mix(in srgb, var(--accent) 18%, white)", boxShadow: "var(--glow-compact)", fontWeight: 800 });
...
globalStyle(`${connectors} path`, { stroke: "color-mix(in srgb, var(--accent) 26%, var(--border-subtle))", strokeWidth: 1.5, fill: "none", filter: "drop-shadow(0 2px 5px color-mix(in srgb, var(--accent) 12%, transparent))", transition: `opacity ${duration.inspectorState} ${easing.standard}` });
