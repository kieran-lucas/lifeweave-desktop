...
export const studioShell = style({ display: "grid", gap: 14 });
...
export const fieldInput = style([focusRing, { width: "100%", border: "1px solid var(--border-subtle)", borderRadius: "var(--radius-control)", padding: "8px 12px", background: "var(--app-background)", color: "var(--text-primary)", ...text.body, boxSizing: "border-box" }]);
export const fieldTextarea = style([fieldInput, { minHeight: 80, resize: "vertical" }]);
export const editorWrap = style({ border: "1px solid var(--accent)", borderRadius: "var(--radius-control)", padding: "12px 14px", minHeight: 120, background: "var(--app-background)", boxShadow: "0 0 0 1px color-mix(in srgb, var(--accent) 18%, transparent)" });
...
export const timelineItems = style({ display: "grid", gap: 0, margin: "6px 0 12px", borderBlockStart: "1px solid var(--border-subtle)" });
export const timelineItemEditor = style({ padding: "12px 0", display: "flex", flexDirection: "column", gap: 7, borderBlockEnd: "1px solid var(--border-subtle)" });
...
export const sceneRenameInput = style([focusRing, { flexGrow: 1, minWidth: 0, background: "none", border: "none", borderBottom: "1px solid var(--border-subtle)", borderRadius: 0, padding: "4px 0", color: "var(--text-primary)", ...text.bodyStrong, selectors: { "&:focus-visible": { borderBottomColor: "var(--focus-ring)" } } }]);
