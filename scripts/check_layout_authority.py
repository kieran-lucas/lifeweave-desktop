...
MAX_RESIDUE = {
    ...
    "font_size": 56,  # feature-local sizes remaining before semantic-role migration
    "focus": 17,       # local focus-visible recipes remaining before shared utility migration
    "control_clone": 47,  # feature-local button/action/trigger style exports
}
