...
export function LifeEditWorkspace({initialNodeId,onBrowse}:{initialNodeId:string;onBrowse:(id:string)=>void}){
 ...
 if(query.isLoading)return <p aria-live="polite">Loading full Life tree…</p>;if(query.isError||!projection)return <p role="alert">Life Edit could not load. Browse remains available.</p>;
