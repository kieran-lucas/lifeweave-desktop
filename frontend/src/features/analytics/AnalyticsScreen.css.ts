 ...
 */
export const periodControls=style([glass,{display:"flex",flexWrap:"wrap",alignItems:"center",justifyContent:"space-between",gap:space.field,padding:space.x4,borderRadius:12,minInlineSize:0}]);
 ...
 */
export const primary=style([glassStrong,{display:"flex",flexDirection:"column",gap:space.x1,margin:0,padding:`${space.x5} ${space.x5}`,borderRadius:14,minInlineSize:0}]);
 ...
 */
export const facts=style([glass,{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(180px, 1fr))",gap:0,margin:0,padding:space.x4,borderRadius:12,minInlineSize:0}]);
...
export const categories=style([glass,{listStyle:"none",padding:space.x4,margin:0,display:"grid",gap:space.field,borderRadius:12,minInlineSize:0}]);
...
globalStyle(`${categories} progress, ${distribution} progress`,{
  appearance:"none",WebkitAppearance:"none",border:0,borderRadius:999,overflow:"hidden",
  accentColor:"var(--accent)",background:"var(--border-subtle)",color:"var(--accent)",
});
globalStyle(`${categories} progress::-webkit-progress-bar, ${distribution} progress::-webkit-progress-bar`,{background:"var(--border-subtle)",borderRadius:999});
globalStyle(`${categories} progress::-webkit-progress-value, ${distribution} progress::-webkit-progress-value`,{background:"var(--accent)",borderRadius:999});

/** Analytics sections sit on the page ground; the modules above provide the material. */
export const module_=style([glass,{padding:space.x4,borderRadius:12,minInlineSize:0}]);
